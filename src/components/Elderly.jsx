  ...
  return (
    <div id="elderly" className="w-screen min-h-[30rem] md:h-[50rem] px-[10vw] md:scroll-mt-30">
      <div className="flex flex-col md:flex-row w-full">
        <div className="w-full basis-1/2 md:w-[50vw] bg-gradient-to-r from-primary z-10 p-8 md:p-12">
          ...
          <div className="w-full basis-1/2 md:w-[50vw] h-[300px] md:h-auto -z-10">
