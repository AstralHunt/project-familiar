...
const Story = () => {
  return (
    <div id="story" className="w-screen min-h-[20rem] px-4 md:px-[10vw] py-6 md:py-12 md:scroll-mt-30">
      <div className="flex gap-14 md:gap-36 h-full w-full">
        ...
        <div className="flex basis-1/2 flex-col gap-4 justify-center items-start w-full">
          <h3>Unconditional Care</h3>
          <div className="flex flex-col md:flex-row items-start font-light justify-between">
            <div id="total"></div>
            <p className="basis-4/5 text-left text-lg">Mean hours per week of informal family care provided to seniors with dementia.  This is substantially higher than the 17 hours provided by caregivers of those without dementia.</p>
          </div>
        </div>
      </div>
    </div>
