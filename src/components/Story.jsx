...
const Story = () => {
  return (
    <div id="story" className="w-screen min-h-[20rem] px-4 md:px-[10vw] py-6 md:py-12 md:scroll-mt-30">
      <div className="border-t-[1px] border-gray-200 h-full w-full">
        <p className="text-sm md:text-base lg:text-lg py-6 md:py-8 max-w-3xl mx-auto text-center">Care partners of older
          adults with dementia provide 26 hours of care a week, on average. This compares to 17 hours a week for older
          adults with other health issues.</p>
