        ...
        <div className="flex justify-between md:justify-start md:basis-4/5 md:gap-8 w-full items-center">
          <div className="py-1">
            ...
            <li className="flex flex-col pr-5" onClick={() => setIsMenuOpen(false)}>
                <a href="#story" className="text-accent opacity-90 hover:text-gray-600 font-bold">DEMENTIA</a>
                <p className="text-xs  opacity-70">The problem</p>
              </li>
              <li className="flex flex-col pr-5" onClick={() => setIsMenuOpen(false)}>
                <a href="#elderly" className="text-primary hover:text-accent font-bold">ELDERLY</a>
                <p className="text-xs opacity-70">Help remember</p>
              </li>
              <li className="flex flex-col pr-5" onClick={() => setIsMenuOpen(false)}>
                <a href="#caregiver" className="text-primary hover:text-accent font-bold">CAREGIVERS</a>
              <p className="text-xs opacity-70">Provide assistance</p>
              </li>
                <li className="flex flex-col pr-5" onClick={() => setIsMenuOpen(false)}>
                  <a href="#team" className="text-primary hover:text-accent font-bold">THE TEAM</a>
